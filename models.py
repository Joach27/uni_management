...
class Eleve(db.Model):
    ...
    notes_examens = db.relationship("NoteExamen", back_populates="eleve", cascade="all, delete-orphan")
    notes_exercices = db.relationship("NoteExercice", back_populates="eleve", cascade="all, delete-orphan")
    soumissions = db.relationship("SoumissionExercice", back_populates="eleve", cascade="all, delete-orphan")
    questions = db.relationship("Question", back_populates="eleve", cascade="all, delete-orphan")
    inscriptions = db.relationship("Inscription", back_populates="eleve", cascade="all, delete-orphan")
...
class Inscription(db.Model):
    ...
    eleve = db.relationship("Eleve", back_populates="inscriptions")
...
class NoteExamen(db.Model):
    ...
    eleve = db.relationship("Eleve", back_populates="notes_examens")
...
class NoteExercice(db.Model):
    ...
    eleve = db.relationship("Eleve", back_populates="notes_exercices")
...
class SoumissionExercice(db.Model):
    ...
    eleve = db.relationship("Eleve", back_populates="soumissions")
...
class Question(db.Model):
    ...
    eleve = db.relationship("Eleve", back_populates="questions")
